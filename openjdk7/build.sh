...
javah -classpath java_classes -d ./class_headers sun.security.smartcardio.PCSC sun.security.smartcardio.PlatformPCSC
...
llvm-gcc -Xlinker -rpath -Xlinker @loader_path/. -Xlinker -install_name -Xlinker @rpath/libj2pcsc.dylib -Wl,-install_name,@rpath/libj2pcsc.dylib -dynamiclib -compatibility_version 1.0.0 -current_version 1.0.0 -ljvm -ljava -L./lib -L./lib/server -o libj2pcsc.dylib x86_64/pcsc.o x86_64/pcsc_md.o
