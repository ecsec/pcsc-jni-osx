...
/System/Library/Frameworks/JavaVM.framework/Commands/javah -classpath java_classes -d ./class_headers org.openecard.scio.osx.PCSC org.openecard.scio.osx.PlatformPCSC
...
llvm-gcc -arch i586 -Xlinker -rpath -Xlinker @loader_path/. -Xlinker -install_name -Xlinker @rpath/libosxj2pcsc.dylib -Wl,-install_name,@rpath/libosxj2pcsc.dylib -dynamiclib -compatibility_version 1.0.0 -current_version 1.0.0 -ljvm -ljava -L./lib_i386 -L./lib_i386/server -o i386/libosxj2pcsc.dylib i386/pcsc.o i386/pcsc_md.o

llvm-gcc -Xlinker -rpath -Xlinker @loader_path/. -Xlinker -install_name -Xlinker @rpath/libosxj2pcsc.dylib -Wl,-install_name,@rpath/libosxj2pcsc.dylib -dynamiclib -compatibility_version 1.0.0 -current_version 1.0.0 -ljvm -ljava -L./lib_x86_64 -L./lib_x86_64/server -o x86_64/libosxj2pcsc.dylib x86_64/pcsc.o x86_64/pcsc_md.o

lipo -create i386/libosxj2pcsc.dylib x86_64/libosxj2pcsc.dylib -output libosxj2pcsc.dylib

install_name_tool -change @rpath/libjava.dylib @rpath/libjava.jnilib libosxj2pcsc.dylib
install_name_tool -change @rpath/libjvm.dylib @rpath/libjvmlinkage.dylib libosxj2pcsc.dylib
